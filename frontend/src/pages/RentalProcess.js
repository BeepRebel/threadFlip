...
const RentalProcess = () => {
  return (
    <div className="rental-process-container">
      <h1 className="rental-process-title">RENTAL PROCESS</h1>
      <div className="rental-steps">
        ...
        <div className="step">
          <FontAwesomeIcon icon={faRuler} className="step-icon" />
        ...
        <div className="step">
          <FontAwesomeIcon icon={faBroom} className="step-icon" />
