...
const CategoryPage = () => {
  ...
  const products = [
    ...
    { 
      id: 3, image: '/images/rent/dresses/2.png', title: 'Sequinned Fishtail Dress', tag: 'MRP ₹2,990', rating: 4.8, rentPrice: '₹500', details: 'Detailed description here', sizes: ['S', 'M', 'L', 'XL', 'XXL'], 
